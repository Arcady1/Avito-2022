...
* Если пользвоатель существует, то указанная сумма зачисляется ему на счёт, и баланс увеличивается.
...
* Если указанная сумма больше, чем заразервированная, то происходит разрезервирование денег:
  * Статус заказа меняется на `canceled`.
  * Сумма заказа возвращается на счёт пользователя.
* Если указанная сумма меньше или равна заразервированной, то происходит списание денег:
